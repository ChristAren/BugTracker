...
namespace BugTracker.Utilities
{
    public static class DataUtility
    {
        ...
        private static async Task SeedRolesAsync(UserManager<BTUser> userManager, RoleManager<IdentityRole> roleManager)
        {
        ...
        private static async Task SeedDefaultUsersAsync(UserManager<BTUser> userManager, RoleManager<IdentityRole> roleManager)
        {
            //Seed Default Admin User
            var defaultUser = new BTUser
            {
                Email = "chrisarensel@gmail.com",
                UserName = "chrisarensel@gmail.com",
                FirstName = "Chris",
                LastName = "Rensel",
                EmailConfirmed = true,
            ...
            try
            {
                ...
                if (user == null)
                {
                    await userManager.CreateAsync(defaultUser, "R3v1tal1z3d!");
